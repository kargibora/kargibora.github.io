...
I hold an MSc in [Machine Learning from the University of Tübingen](https://uni-tuebingen.de/fakultaeten/mathematisch-naturwissenschaftliche-fakultaet/fachbereiche/informatik/studium/studierende/lehre-studienorganisation/studiengaenge/machine-learning/) and a BSc in Computer Engineering from [Middle East Technical University (METU)](https://www.metu.edu.tr/). During my master's, I worked as a research assistant (HiWi) on [Scholar Inbox](https://www.scholar-inbox.com/), contributing to its paper-recommendation system in Prof. Andreas Geiger's Autonomous Vision Group. For my thesis, supervised by Prof. Seong Joon Oh in the [Scalable Trustworthy AI group](https://s-t-a-i.github.io/), I studied a fragility of CLIP-based vision–language models — how they can be misled by plausible but incorrect details ("half-truths").
